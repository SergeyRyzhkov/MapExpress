...
namespace MapExpress.Tests.Referencing.Operations
{
    ...
    public class GeographicGeocentricConversionTest
    {
        ...
        {
            var g = PrimeMeridianRegistry.Instance.Greenwich; 
            ...
            var convertor = new GeocentricGeographicConversion (EllipsoidRegistry.Instance.WGS84);

            Assert.AreEqual (resultCoordinate, convertor.ToGeographic (sourceCoordinate));

            Assert.AreEqual (resultCoordinate, convertor.Inverse ().Transform (sourceCoordinate));
        }
        ...
        public void ToGeocentricTest ()
        {
            ...
            Assert.AreEqual (resultCoordinate, convertor.ToGeocentric (sourceCoordinate));
